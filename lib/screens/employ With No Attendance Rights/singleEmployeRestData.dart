...
class SingleEmployeRestDetails extends StatefulWidget {
  const SingleEmployeRestDetails({Key? key}) : super(key: key);

  @override
  State<SingleEmployeRestDetails> createState() =>
      _SingleEmployeRestDetailsState();
}

class _SingleEmployeRestDetailsState
    extends State<SingleEmployeRestDetails> {
  @override
  void initState() {
    getUserName();
    // currentMonth();
            ...
            child: Column(
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Align(
                        ...
                        child: text(context, 'Rest Day Details', 22.sp,
                            fontFamily: "Poppins",
                ...
                prov.singleUserAttendanceloading
                    ...
                    :prov.singleUserRESTDetails.isEmpty?Column(
                      children: [
                      SizedBox(
                        ...
                        itemCount: prov.singleUserRESTDetails.isEmpty
                            ? 0
                            : prov.singleUserRESTDetails.length,
                        itemBuilder: (context, i) {
                          SingleUserAttendanceModel cate =
                              prov.singleUserRESTDetails[i];
                          log(prov.singleUserRESTDetails.length.toString());
                          debugPrint(
                              ' cate.attendanceStatus: ${cate.attendanceStatus}');
                          debugPrint('selectedValue: $cate');
                          return prov.singleUserRESTDetails.isNotEmpty
                              ? presentWidget(cate)
                              : Center(
                                  child: text(
                                    context,
    ...
    return   Container(
        ...
        child: Row(children: [
          Container(
            ...
            child:wholedata.employeDESCR == "REST"? Container(
          ...
          SizedBox(
            width: 20.w,
                ...
                context,
                // 'Present',
                wholedata.attendanceStatus =="R"? 'REST':'',
                16.sp,
                // color: greenShade,
                color: wholedata.attendanceStatus
                 == "R" ? greenShade : readcolor,
                fontFamily: "Poppins",

...
class SingleEmployePresentDetails extends StatefulWidget {
  const SingleEmployePresentDetails({Key? key}) : super(key: key);

  @override
  State<SingleEmployePresentDetails> createState() =>
      _SingleEmployePresentDetailsState();
}

class _SingleEmployePresentDetailsState
    extends State<SingleEmployePresentDetails> {
  @override
  void initState() {
    getUserName();
    // currentMonth();
            ...
            child: Column(
              children: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Align(
                        ...
                        child: text(context, 'Present Details', 22.sp,
                            fontFamily: "Poppins",
                ...
                prov.singleUserAttendanceloading
                    ...
                    : prov.singleUserPresentDetails.isEmpty
                        ? Column(
                            children: [
                              SizedBox(
                                height:
                        ...
                        : ListView.builder(
                            ...
                            itemCount: prov.singleUserPresentDetails.isEmpty
                                ? 0
                                : prov.singleUserPresentDetails.length,
                            itemBuilder: (context, i) {
                              SingleUserAttendanceModel cate =
                                  prov.singleUserPresentDetails[i];
                              log(prov.singleUserPresentDetails.length
                                  .toString());
                              debugPrint(
                                  ' cate.attendanceStatus: ${cate.attendanceStatus}');
                              debugPrint('selectedValue: $cate');
                              return prov.singleUserPresentDetails.isNotEmpty
                                  ? presentWidget(cate)
                                  : Center(
                                      child: text(
                                        context,
    ...
    return Container(
      ...
      child: Row(children: [
        Container(
          ...
          child: wholedata.employeDESCR == "PRESENT"
              ? Container(
        ...
        text(
          context,
          // 'Present',
          wholedata.attendanceStatus == "P" ? 'PRESENT' : '',
          16.sp,
          // color: greenShade,
